#!/usr/bin/env python3
"""
Vision Transformer (ViT) Fine-tuning Script for CIFAR-100 with Gradient Chain Selection
...
SAVE_DIR = "../../saved_models_pretrained/vit_cifar100_gradient_chain"
...
peft_config = PacaConfig(
    ...
    num_arms=16,                         # Number of chains to create
    num_arms_to_select=8,               # Number of chains to activate per epoch
    
    # Chain construction parameters
    gradient_chain_warmup_epochs=2,     # Build chains after 3 epochs of warmup
...
def train(model, train_loader, val_loader, criterion, optimizer, scheduler, epochs, patience=10):
