#!/usr/bin/env python3
"""
Vision Transformer (ViT) Fine-tuning Script for CIFAR-100 with Gradient Chain Selection (Ablation Study)
...
# Argument Parsing
parser = argparse.ArgumentParser(description="ViT Fine-tuning on CIFAR-100 with Gradient Chain Selection Ablation")
parser.add_argument("--num_arms", type=int, default=3, help="Number of chains to create")
parser.add_argument("--num_arms_to_select", type=int, default=1, help="Number of chains to activate per epoch")
...
# Paths
# Use absolute paths to avoid PermissionError and CWD issues
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
PROJECT_ROOT = os.path.abspath(os.path.join(SCRIPT_DIR, "../../../"))
DATA_DIR = os.path.join(PROJECT_ROOT, "data")
SAVE_DIR = os.path.join(PROJECT_ROOT, "saved_models_pretrained", f"vit_cifar100_gradient_chain_ablation_arms{args.num_arms}_select{args.num_arms_to_select}")
...
print("=" * 60)
print("Vision Transformer Fine-tuning on CIFAR-100")
print("Using Gradient Chain Selection (Ablation)")
print(f"Num Arms: {args.num_arms}, Num Arms to Select: {args.num_arms_to_select}")
print("=" * 60)
...
peft_config = PacaConfig(
    ...
    num_arms=args.num_arms,             # Number of chains to create
    num_arms_to_select=args.num_arms_to_select, # Number of chains to activate per epoch
...
print("\n" + "=" * 60)
print("Fine-tuning ViT using Gradient Chain Selection:")
print("=" * 60)
