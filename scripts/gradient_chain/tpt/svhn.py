#!/usr/bin/env python3
"""
Vision Transformer (ViT) Throughput Measurement Script for SVHN

This script measures and compares the training throughput (images/sec) of
Full Fine-Tuning, LoRA, and PaCA (Gradient Chain) on the SVHN dataset.
"""
import os
import time
import torch
...
def create_dataloader(batch_size):
    ...
    # Download and load SVHN dataset directly from torchvision
...
def plot_results(results):
    ...
    ax.set_title("ViT Fine-Tuning Throughput on SVHN (Gradient Chain)", fontsize=16)
    ...
    plt.tight_layout()
    save_path = "throughput_gradient_chain_svhn.png"
...
def main():
    ...
    print("=" * 60)
    print("Starting Throughput Analysis for ViT on SVHN")
    ...
    for method in METHODS_TO_TEST:
        ...
        for batch_size in BATCH_SIZES_TO_TEST:
            ...
            try:
                ...
                model = create_model(num_classes=10, method=method, trainloader=train_loader)
