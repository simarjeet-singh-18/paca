...
Full Fine-Tuning, LoRA, and PaCA (Gradient Chain) on the CIFAR-100 dataset.
"""
import os
import time
import torch
...
def plot_results(results):
    ...
    ax.set_title("ViT Fine-Tuning Throughput on CIFAR-100 (Gradient Chain)", fontsize=16)
    ...
    plt.tight_layout()
    save_path = "throughput_gradient_chain_cifar100.png"
