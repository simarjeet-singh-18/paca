#!/usr/bin/env python3
"""
Vision Transformer (ViT) Fine-tuning Script for Flowers-102 with Gradient Chain Selection
...
SAVE_DIR = "../../saved_models_pretrained/vit_flowers102_gradient_chain"
...
print("Using Gradient Chain Selection")
print("=" * 60)
