...
SAVE_DIR = "../../../saved_models_pretrained/vit_flowers102_paca_fixed"
...
print("Using PaCA - Fixed 25 Epochs")
print("=" * 60)
...
def train(model, train_loader, val_loader, criterion, optimizer, scheduler, epochs):
    ...
    for epoch in range(epochs):
        ...
        print(f"\nEpoch {epoch+1}/{epochs} | LR: {scheduler.get_last_lr()[0]:.6f} | Time: {epoch_time:.2f}")
