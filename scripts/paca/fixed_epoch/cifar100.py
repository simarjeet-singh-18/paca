...
# Paths
DATA_DIR = "../../data/SVHN"
SAVE_DIR = "../../../saved_models_pretrained/vit_cifar100_paca_fixed"
...
def create_dataloaders():
    ...
    # Get number of classes (Flowers102 has 102 classes)
    num_classes = 100
...
print("=" * 60)
print("Vision Transformer Fine-tuning on cifar100")
...
print("Fine tuning vit using Normal PaCA:")
