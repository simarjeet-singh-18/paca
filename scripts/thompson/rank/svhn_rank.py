#!/usr/bin/env python3
"""
Vision Transformer (ViT) Fine-tuning Script for SVHN with Gaussian Thompson Sampling
...
# Argument Parsing
parser = argparse.ArgumentParser(description="ViT Fine-tuning on SVHN with Gaussian Thompson Sampling")
...
SAVE_DIR = os.path.join(PROJECT_ROOT, "saved_models_pretrained", f"vit_svhn_thompson_r{args.rank}")
...
print(f"Using Gaussian Thompson Sampling - Rank {args.rank}")
print("=" * 60)
