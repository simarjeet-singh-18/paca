...
SAVE_DIR = "../../../saved_models_pretrained/vit_flowers102_gaussian_fixed"
...
def create_dataloaders():
    ...
    # Define the sizes for our 80/20 split
    ...
    # Create non-augmented datasets for test set
...
print("Using Gaussian Thompson Sampling - Fixed 25 Epochs")
print("=" * 60)
