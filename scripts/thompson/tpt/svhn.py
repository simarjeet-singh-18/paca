...
Full Fine-Tuning, LoRA, and PaCA (Thompson Sampling) on the SVHN dataset.
"""
import os
import time
import torch
...
def plot_results(results):
    ...
    ax.set_title("ViT Fine-Tuning Throughput on SVHN (Thompson Sampling)", fontsize=16)
    ...
    plt.tight_layout()
    save_path = "throughput_thompson_svhn.png"
