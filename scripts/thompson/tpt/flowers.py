...
Full Fine-Tuning, LoRA, and PaCA (Thompson Sampling) on the Flowers-102 dataset.
"""
import os
import time
import torch
...
def plot_results(results):
    ...
    ax.set_title("ViT Fine-Tuning Throughput on Flowers-102 (Thompson Sampling)", fontsize=16)
    ...
    plt.tight_layout()
    save_path = "throughput_thompson_flowers.png"
