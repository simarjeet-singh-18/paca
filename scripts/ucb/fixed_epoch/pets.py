#!/usr/bin/env python3
"""
Vision Transformer (ViT) Fine-tuning Script for Oxford-IIIT Pets Dataset
...
# Paths
DATA_DIR = "../../data/pets"
SAVE_DIR = "../../saved_models_pretrained/vit_pets_fixed25"
...
def create_dataloaders():
    ...
    # Download and load Oxford-IIIT Pets dataset
    ...
    # Get number of classes (Oxford-IIIT Pets has 37 classes)
    num_classes = 37
...
def train(model, train_loader, val_loader, criterion, optimizer, scheduler, epochs):
    ...
    torch.save(best_indices, "best_indices_pets.pt")
