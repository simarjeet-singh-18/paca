#!/usr/bin/env python3
"""
Vision Transformer (ViT) Fine-tuning Script for SVHN Dataset
...
# Paths
DATA_DIR = "../../data/SVHN"
SAVE_DIR = "../../saved_models_pretrained/vit_svhn_fixed25"
...
def train(model, train_loader, val_loader, criterion, optimizer, scheduler, epochs):
    ...
    torch.save(best_indices, "best_indices_svhn.pt")
