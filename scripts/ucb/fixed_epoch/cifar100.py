#!/usr/bin/env python3
"""
Vision Transformer (ViT) Fine-tuning Script for CIFAR-100 Dataset
...
SAVE_DIR = "../../saved_models_pretrained/vit_cifar100_fixed25"
...
def train(model, train_loader, val_loader, criterion, optimizer, scheduler, epochs):
    ...
    torch.save(best_indices, "best_indices_cifar100.pt")
