...
SAVE_DIR = "../../saved_models_pretrained/vit_caltech101"
...
def create_dataloaders():
    ...
    print(f"Dataset loaded: {total_samples} samples across {num_classes} classes")
...
save_model_path = '../../saved_models_paca/vmamba_cifar100_normal/r_8'  
